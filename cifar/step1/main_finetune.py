...
parser.add_argument('--refine', default='../step1/cifar10/pruned_models/res110_norm.pth.tar', type=str, metavar='PATH',
...
def main():
    ...
    if args.dataset == 'cifar10':
        train_loader, valid_loader =get_train_valid_loader('./cifar10/cifar10',
                           args.batch_size,
                           augment=True,
        ...
        test_loader = get_test_loader('./cifar10/cifar10',
                    args.batch_size,
                    shuffle=False,
                    num_workers=4,
                    pin_memory=True)
