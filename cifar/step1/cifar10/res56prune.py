...
parser.add_argument('-v', default='C', type=str,
...
torch.save({'cfg': cfg, 'state_dict': newmodel.state_dict()}, os.path.join(args.save, 'res56.pth.tar'))
...
with open(os.path.join(args.save, "res56.txt"), "w") as fp:
