...
parser.add_argument('--model', default='./pretrained_models/mobilenetv2_c100_0.7501.tar', type=str, metavar='PATH',
...
for [m0, m1] in zip(model.modules(), newmodel.modules()):
    if isinstance(m0, nn.Conv2d):
        ...
        m1.bias.data = m0.bias.data.clone()
print(cfg)
torch.save({'cfg': cfg, 'state_dict': newmodel.state_dict()}, os.path.join(args.save, 'mobilenetv2_c100.pth.tar'))
...
with open(os.path.join(args.save, "mobilenetv2_c100.txt"), "w") as fp:
